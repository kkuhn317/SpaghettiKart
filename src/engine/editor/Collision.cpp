        ...
        switch (opcode) {
            ...
            case G_DL_OTR_HASH:
                ...
                GenerateCollisionMesh(
                    object, (Gfx*) ResourceGetDataByCrc(((uint64_t) (ptr->words.w0 << 32)) + ptr->words.w1), scale);
                break;
...
void DebugCollision(GameObject* obj, FVector pos, IRotator rot, FVector scale, const std::vector<Triangle>& triangles) {
    ...
    if (vtxBuffer.empty()) {
        for (const auto& tri : triangles) {
            vtxBuffer.push_back(
                { (s16) tri.v0.x, (s16) tri.v0.y, (s16) tri.v0.z, 0, { 0, 0 }, { 255, 255, 255, 255 } });
            vtxBuffer.push_back(
                { (s16) tri.v1.x, (s16) tri.v1.y, (s16) tri.v1.z, 0, { 0, 0 }, { 255, 255, 255, 255 } });
            vtxBuffer.push_back(
                { (s16) tri.v2.x, (s16) tri.v2.y, (s16) tri.v2.z, 0, { 0, 0 }, { 255, 255, 255, 255 } });
        }
    }

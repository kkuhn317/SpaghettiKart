...
void PodiumCeremony::BeginPlay() {
    ...
    gWorldInstance.AddObject(new OCheepCheep(FVector((f32) -3202, (f32) 19, (f32) -478),
                                             OCheepCheep::CheepType::PODIUM_CEREMONY, IPathSpan(0, 0)));
    ...
    OTrophy* trophy = reinterpret_cast<OTrophy*>(
